...
const CurrentTemperatureCard = () => {
	...
	useEffect(() => {
		// Funkcja pobierająca dane z Open-Meteo API
	...
	return (
		<div className='flex flex-col items-center justify-center gap-4 p-5 rounded-2xl shadow-xl bg-gray-800 text-white w-full'>
			...
			<div className='flex flex-row justify-center items-center gap-3'>
				<FontAwesomeIcon icon={faThermometerHalf} className='text-5xl text-mainColor' />
			...
			<p className='text-3xl font-semibold text-center'>
				{temperature !== null ? `${temperature.toFixed(1)}°C` : 'Ładowanie...'}
			</p>
		</div>
	)
}
